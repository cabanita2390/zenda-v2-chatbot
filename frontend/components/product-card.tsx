...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link href={`/productos/${product.id}`} className="group block">
      <Card 
        className="cursor-pointer overflow-hidden border-border/50 bg-card shadow-sm transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:border-border"
      >
